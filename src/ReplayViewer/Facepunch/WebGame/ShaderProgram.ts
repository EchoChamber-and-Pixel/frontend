import { VertexAttribute, Uniform, Material, CommandBuffer, IUniformCtor } from ".";
...
export abstract class ShaderProgram {
    ...
    getProgram(): WebGLProgram {
        if (this.program === undefined) {
            return this.program = this.context.createProgram() as WebGLProgram;
        }
        return this.program;
    }
    ...
    bufferDisableAttributes(buf: CommandBuffer) {
        this.bufferEnableAttributes(buf, undefined);
    }
