import { Game, MeshGroup, ICompressedMeshData, IMeshData, VertexAttribute, IMeshElement, Material, MeshHandle, DrawMode } from ".";
import { Utils, Vector3, Vector4 } from "..";
...
export class MeshManager {
    ...
    static decompress(compressed: ICompressedMeshData): IMeshData {
        ...
        for (let i = 0, iEnd = compressed.attributes.length; i < iEnd; ++i) {
            ...
            attribs.push(typeof attrib === "string" ? (VertexAttribute as any)[attrib] : attrib);
        }
            ...
            elements: [
                {
                    ...
                    material: this.game.shaders.createMaterial(Shaders.ComposeFrame, false),
                    indexOffset: 0,
                    indexCount: 6
                }
            ]
