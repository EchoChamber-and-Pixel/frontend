import { Vector2, Vector3 } from "../Facepunch";
...
export class BinaryReader {
    ...
    */
    ...
    readVector2(vec?: Vector2): Vector2 {
        if (vec === undefined) vec = new Vector2();
        vec.set(this.readFloat32(), this.readFloat32());
        return vec;
    }

    readVector3(vec?: Vector3): Vector3 {
        if (vec === undefined) vec = new Vector3();
