...
export class BspLeaf extends DrawListItem implements INodeOrLeaf {
    ...
    constructor(viewer: MapViewer, info: IBspLeaf) {
        ...
        this.cluster = info.cluster as number;
        this.hasFaces = info.hasFaces;
    }

    private static readonly getAmbientCube_temp = new Vector3();
    getAmbientCube(pos: IVector3 | null, outSamples: IVector3[] | null, callback?: (success: boolean) => void): boolean {
        ...
        if (pos != null) {
            ...
            for (let i = 0; i < 6; ++i) {
                ...
                const outVec = outSamples![i] || (outSamples![i] = new Vector3());
...
export class BspModel extends RenderResource<BspModel> {
    ...
    getLeafAt(pos: IVector3): BspLeaf {
        ...
        return (elem.isLeaf ? elem : null) as BspLeaf;
    }
