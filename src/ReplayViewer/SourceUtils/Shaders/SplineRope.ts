...
export class SplineRope extends ModelBase<SplineRopeMaterial> {
    private uAmbient0 = this.addUniform("uAmbient[0]", Uniform3F);
    private uAmbient1 = this.addUniform("uAmbient[1]", Uniform3F);
    private uAmbient2 = this.addUniform("uAmbient[2]", Uniform3F);
    private uAmbient3 = this.addUniform("uAmbient[3]", Uniform3F);
    private uAmbient4 = this.addUniform("uAmbient[4]", Uniform3F);
    private uAmbient5 = this.addUniform("uAmbient[5]", Uniform3F);
    ...
    constructor(context: WebGLRenderingContext) {
        ...
        this.addAttribute("aTangent", VertexAttribute.normal);
        this.addAttribute("aSplineParams", VertexAttribute.uv2);

        this.compile();
    }

    bufferMaterialProps(buf: CommandBuffer, props: SplineRopeMaterial): void {
